...
export default function MasterDataPage() {
  ...
  const [form, setForm] = useState({
    sku: '', nama: '', kategori: '', satuan: '', harga: 0, stok_saat_ini: 0, stok_minimum: 0,
  });
  ...
  function resetForm() {
    setForm({ sku: '', nama: '', kategori: '', satuan: '', harga: 0, stok_saat_ini: 0, stok_minimum: 0 });
    setEditingId(null);
  }
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
              ...
              <input
                placeholder="Contoh: SKU006"
                value={form.sku}
                disabled={!!editingId}
                onChange={(e) => setForm({ ...form, sku: e.target.value })}
                className="w-full border border-slate-300 rounded-lg px-3 py-2 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-slate-100 disabled:text-slate-400"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-300 rounded-lg px-3 py-2 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
